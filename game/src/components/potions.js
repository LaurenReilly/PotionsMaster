let  potions = [
    ...
    {name: "Confusion", 
        ...
        insult: "Careful with this one, you can't afford to be more lost."},
    {name: "Invisibility", 
    ...
    {name: "Babbling Beverage",
        recipe: ["a drop of dragon blood", "beetle eyes", "powdered bicorn horn"],
        insult: "Do not test this potion, you spout enough nonsense already."},
    {name: "Calming Draught",
        recipe: ["boomslang skin", "an eye of newt", "beetle eyes", "boomslang skin"],
        insult: "Dumbledore still refuses to let me add this to our student's pumpkin juice."},
    {name: "Dragon Tonic",
        recipe: ["an eye of newt", "powdered bicorn horn", "beetle eyes", "a drop of dragon blood"],
        insult: "Maybe we'll let you give this to the dragon yourself and hopefully you won't come back."},
    {name: "Rat Tonic",
        recipe: ["a drop of dragon blood","a lacewing fly", "beetle eyes"],
